...
const Signup = (props) => {
    ...
    const handleSubmit = async (e)=>{
        ...
        if(credentials.password !== credentials.confirmPassword){
            return alert("Wrong Confirmed Password");
        }
    ...
    return (
        <div className='container my-3'>
            ...
            <h2 className='my-3'>Create an account to Continue to EasyNotes</h2>
            
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    <label htmlFor="name" className="form-label">Name</label>
                    <input type="text" className="form-control" id="name" name="name" onChange={onChange} minLength={1} required/>
                </div>
                <div className="mb-3">
