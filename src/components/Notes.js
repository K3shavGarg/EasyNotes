    ...
    return (
        <>
                        ...
                        <div className="modal-body">
                            <form className='my-3'>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="etag" name="etag" value={note.etag} onChange={onChange} minLength={1}/>
                                </div>
                            </form>
                        </div>
            ...
            <div className='container row my-3'>
                <h2>Your Notes</h2>
                {notes.length===0 && <div className='text-muted mx-1'>No notes to display</div>}
                {
                    notes.map((note) => {
